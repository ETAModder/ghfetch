...
You can now submit **themes**! Just submit a PR with your theme in the ```/themes``` folder.  
Themes should just be the original ```ghfetch.src``` but with changed colors/variables/ascii art.

*Compile and star GHfetch today to say "I use Ellipse BTW"!*
